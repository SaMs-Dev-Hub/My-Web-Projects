...
var clothing = document.getElementById("cloth");

var accessories = document.getElementById("acc");
...
for (var counter = 0; counter <= productList.length; counter++) {
  ...
  // anchor.href = '/product.html?product_id' + currentProduct.id;
  ...
  h5.innerText = "Rs " + currentProduct.price;
  ...
  if (currentProduct.isAccessory === true) {
